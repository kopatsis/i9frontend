 ...
 * @returns {Promise<Object>} A promise that resolves with the full response object.
 */
export async function restartWorkoutByID(token, id) {
	const baseUrl = import.meta.env.VITE_BACKEND_URL;
	const url = baseUrl + '/workouts/restart/' + id;
	const options = {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
 ...
 * @returns {Promise<Object>} A promise that resolves with the full response object.
 */
export async function restartStretchWorkoutByID(token, id) {
	const baseUrl = import.meta.env.VITE_BACKEND_URL;
	const url = baseUrl + '/workouts/stretch/restart/' + id;
	const options = {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
 ...
 * @returns {Promise<Object>} A promise that resolves with the full response object.
 */
export async function restartIntroWorkoutByID(token, id) {
	const baseUrl = import.meta.env.VITE_BACKEND_URL;
	const url = baseUrl + '/workouts/intro/restart/' + id;
	const options = {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
